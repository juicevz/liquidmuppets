...
const docsSections: DocsSection[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'revenue accumulates between weekly routes; a zero-revenue epoch distributes zero',
      ...
      'the public /app/revenue page shows both routes; each Muppet page shows Key volume, fees, committed units, latest eligible weight, WETH per 1x unit, $MUPPETS bought and receipts',
